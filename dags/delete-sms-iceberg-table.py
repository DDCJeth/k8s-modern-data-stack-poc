...
with DAG(
    ...
    bronze_table = SparkKubernetesOperator(
        ...
        params={**COMMON_PARAMS, 'job_name': 'delete-sms-bronze', 'main_class': 'DropIcebergTable', 'schema':'bronze', 'logType':'sms'}
    )
    ...
    silver_table = SparkKubernetesOperator(
        ...
        namespace=COMMON_PARAMS['namespace'],
        application_file='batch-template-deleteTable.yml',
        params={**COMMON_PARAMS, 'job_name': 'delete-sms-silver', 'main_class': 'DropIcebergTable', 'schema': 'silver', 'logType':'sms'}
    )
    ...
    gold_table = SparkKubernetesOperator(
        ...
        namespace=COMMON_PARAMS['namespace'],
        application_file='batch-template-deleteTable.yml',
        params={**COMMON_PARAMS, 'job_name': 'delete-sms-gold', 'main_class': 'DropIcebergTable', 'schema': 'gold', 'logType':'sms_daily_global_kpis'}
    )
    ...
    gold_tower_table = SparkKubernetesOperator(
        ...
        namespace=COMMON_PARAMS['namespace'],
        application_file='batch-template-deleteTable.yml',
        params={**COMMON_PARAMS, 'job_name': 'delete-sms-gold-tower', 'main_class': 'DropIcebergTable', 'schema': 'gold', 'logType':'sms_daily_tower_kpis'}
    )
