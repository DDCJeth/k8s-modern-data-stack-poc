...
with DAG(
    ...
    bronze_job = SparkKubernetesOperator(
        ...
        namespace='artefact',
        application_file='sparkapp/sms-batch-bronze-table.yml',
    ...
    silver_job = SparkKubernetesOperator(
        ...
        namespace='artefact',
        application_file='sparkapp/sms-batch-silver-table.yml',
        kubernetes_conn_id='kubernetes_default',
    )
    ...
    gold_job = SparkKubernetesOperator(
        ...
        namespace='artefact',
        application_file='sparkapp/sms-batch-gold-tables.yml',
        kubernetes_conn_id='kubernetes_default',
    )
