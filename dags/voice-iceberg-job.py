...
with DAG(
    ...
    tags=['spark', 'kubernetes', 'voice', 'iceberg'],
    catchup=False,
) as dag:
    ...
    bronze_job = SparkKubernetesOperator(
        ...
        namespace='artefact',
        application_file='sparkapp/voice-batch-bronze-table.yml',
    ...
    silver_job = SparkKubernetesOperator(
        ...
        namespace='artefact',
        application_file='sparkapp/voice-batch-silver-table.yml',
        kubernetes_conn_id='kubernetes_default',
    )
    ...
    gold_job = SparkKubernetesOperator(
        ...
        namespace='artefact',
        application_file='sparkapp/voice-batch-gold-tables.yml',
        kubernetes_conn_id='kubernetes_default',
    )
